...
void main(void) {
    ...
    while(1){
        ...
        if((state==0&&PORTCbits.RC0==1)||(state==9&&PORTCbits.RC0==1)){
            _delay((unsigned long)((90)*(1000000/4000.0)));
            if(PORTCbits.RC0==1){
                state = 1;
            }
        }
        if(state==1&&PORTCbits.RC0==0){
            state = 2;
        }
        if((state==2&&PORTCbits.RC0==1)||(state==11&&PORTCbits.RC0==1)){
            _delay((unsigned long)((90)*(1000000/4000.0)));
            if(PORTCbits.RC0==1){
                state = 3;
            }
        }
        if(state==3&&PORTCbits.RC0==0){
            state = 4;
        }
        if((state==4&&PORTCbits.RC0==1)||(state==13&&PORTCbits.RC0==1)){
            _delay((unsigned long)((90)*(1000000/4000.0)));
            if(PORTCbits.RC0==1){
                state = 5;
            }
        }
        if(state==5&&PORTCbits.RC0==0){
            state = 6;
        }
        if(state==6&&PORTCbits.RC0==1){
            _delay((unsigned long)((90)*(1000000/4000.0)));
            if(PORTCbits.RC0==1){
                state = 7;
            }
        }
        if(state==7&&PORTCbits.RC0==0){
            state = 0;
        }

        if((state==0&&PORTCbits.RC1==1)||(state==2&&PORTCbits.RC1==1)){
            _delay((unsigned long)((90)*(1000000/4000.0)));
            if(PORTCbits.RC1==1){
                state = 8;
            }
        }
        if(state==8&&PORTCbits.RC1==0){
            state = 9;
        }
        if(state==9&&PORTCbits.RC1==1){
            _delay((unsigned long)((90)*(1000000/4000.0)));
            if(PORTCbits.RC1==1){
                state = 10;
            }
        ...
        if(state==4&&PORTCbits.RC1==1){
            _delay((unsigned long)((90)*(1000000/4000.0)));
            if(PORTCbits.RC1==1){
                state = 15;
            }
        }
        if(state==10&&PORTCbits.RC1==0){
            state = 11;
        }
        if(state==11&&PORTCbits.RC1==1){
            _delay((unsigned long)((90)*(1000000/4000.0)));
            if(PORTCbits.RC1==1){
                state = 12;
            }
        ...
        if(state==6&&PORTCbits.RC1==1){
            _delay((unsigned long)((90)*(1000000/4000.0)));
            if(PORTCbits.RC1==1){
                state = 16;
            }
        }
        if(state==12&&PORTCbits.RC1==0){
            state = 13;
        }
        if(state==13&&PORTCbits.RC1==1){
            _delay((unsigned long)((90)*(1000000/4000.0)));
            if(PORTCbits.RC1==1){
                state = 14;
            }
        }
        if(state==15&&PORTCbits.RC1==0){
            state = 11;
        }
        if(state==16&&PORTCbits.RC1==0){
            state = 13;
        }
        if(state==14&&PORTCbits.RC1==0){
            state = 0;
        }


        if(PORTCbits.RC2==1&&state<7){
