...
void main(void) {
    enum {LEDs_off, first_hold_1, D1_on_1, second_hold_1, D2_on_1, third_hold_1, D3_on_1, fourth_hold_1} state_1;
    ...
    while(1){
        switch(state_1){
            case LEDs_off: if(PORTCbits.RC0==1)
                           {state_1=first_hold_1;
                           }
                            else{state_1=LEDs_off;
                             LATCbits.LATC3 =0;
                             LATCbits.LATC4=0;
                             LATCbits.LATC5=0;
                           } break;
            case first_hold_1: if(PORTCbits.RC0==0)
                               {state_1=D1_on_1;
                                 LATCbits.LATC3 =1;
                                 LATCbits.LATC4=0;
                                 LATCbits.LATC5=0;
                               } else{state_1=first_hold_1;
                               } break;
            case D1_on_1: if(PORTCbits.RC0==1)
                            {state_1=second_hold_1;}
                            else{state_1=D1_on_1;
                            } break;
            case second_hold_1: if(PORTCbits.RC0==0)
                                {state_1=D2_on_1;
                                 LATCbits.LATC3=0;
                                 LATCbits.LATC4=1;
                                 LATCbits.LATC5=0;
                                } else{state_1=second_hold_1;
                                } break;
            case D2_on_1: if(PORTCbits.RC0==1)
                            {state_1=third_hold_1;}
                            else{state_1=D2_on_1;
                            } break;
            case third_hold_1: if(PORTCbits.RC0==0)
                               {state_1=D3_on_1;
                                LATCbits.LATC3=0;
                                LATCbits.LATC4=0;
                                LATCbits.LATC5=1;
                               } else{state_1=third_hold_1;
                               } break;
            case D3_on_1: if(PORTCbits.RC0==1)
                            {state_1=fourth_hold_1;
                            } else{state_1=D3_on_1;
                            } break;
            default: if(PORTCbits.RC0==0)
                            {state_1=LEDs_off;
                             LATCbits.LATC3=0;
                             LATCbits.LATC4=0;
                             LATCbits.LATC5=0;
                            } else{state_1=fourth_hold_1;
                            }
    }
    return;
   }
