...
#define LCD_REG       PORTC                           // LCD register pin and select pin RS, RW and E
#define LCD_DB4       PORTCbits.RC3                   // LCD high order bus DB4-DB7
#define LCD_DB5       PORTCbits.RC4
#define LCD_DB6       PORTCbits.RC5
