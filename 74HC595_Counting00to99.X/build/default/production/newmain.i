...
void main(void) {
    ...
    while(1){
        ...
        state_0(); pulse_gen(1); state_0(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_0(); pulse_gen(1); state_1(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_0(); pulse_gen(1); state_2(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_0(); pulse_gen(1); state_3(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_0(); pulse_gen(1); state_4(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_0(); pulse_gen(1); state_5(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_0(); pulse_gen(1); state_6(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_0(); pulse_gen(1); state_7(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_0(); pulse_gen(1); state_8(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_0(); pulse_gen(1); state_9(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));

        state_1(); pulse_gen(1); state_0(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_1(); pulse_gen(1); state_1(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_1(); pulse_gen(1); state_2(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_1(); pulse_gen(1); state_3(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_1(); pulse_gen(1); state_4(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_1(); pulse_gen(1); state_5(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_1(); pulse_gen(1); state_6(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_1(); pulse_gen(1); state_7(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_1(); pulse_gen(1); state_8(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_1(); pulse_gen(1); state_9(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));

        state_2(); pulse_gen(1); state_0(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_2(); pulse_gen(1); state_1(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_2(); pulse_gen(1); state_2(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_2(); pulse_gen(1); state_3(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_2(); pulse_gen(1); state_4(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_2(); pulse_gen(1); state_5(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_2(); pulse_gen(1); state_6(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_2(); pulse_gen(1); state_7(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_2(); pulse_gen(1); state_8(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_2(); pulse_gen(1); state_9(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));

        state_3(); pulse_gen(1); state_0(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_3(); pulse_gen(1); state_1(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_3(); pulse_gen(1); state_2(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_3(); pulse_gen(1); state_3(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_3(); pulse_gen(1); state_4(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_3(); pulse_gen(1); state_5(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_3(); pulse_gen(1); state_6(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_3(); pulse_gen(1); state_7(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_3(); pulse_gen(1); state_8(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_3(); pulse_gen(1); state_9(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));

        state_4(); pulse_gen(1); state_0(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_4(); pulse_gen(1); state_1(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_4(); pulse_gen(1); state_2(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_4(); pulse_gen(1); state_3(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_4(); pulse_gen(1); state_4(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_4(); pulse_gen(1); state_5(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_4(); pulse_gen(1); state_6(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_4(); pulse_gen(1); state_7(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_4(); pulse_gen(1); state_8(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_4(); pulse_gen(1); state_9(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));

        state_5(); pulse_gen(1); state_0(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_5(); pulse_gen(1); state_1(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_5(); pulse_gen(1); state_2(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_5(); pulse_gen(1); state_3(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_5(); pulse_gen(1); state_4(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_5(); pulse_gen(1); state_5(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_5(); pulse_gen(1); state_6(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_5(); pulse_gen(1); state_7(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_5(); pulse_gen(1); state_8(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_5(); pulse_gen(1); state_9(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));

        state_6(); pulse_gen(1); state_0(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_6(); pulse_gen(1); state_1(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_6(); pulse_gen(1); state_2(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_6(); pulse_gen(1); state_3(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_6(); pulse_gen(1); state_4(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_6(); pulse_gen(1); state_5(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_6(); pulse_gen(1); state_6(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_6(); pulse_gen(1); state_7(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_6(); pulse_gen(1); state_8(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_6(); pulse_gen(1); state_9(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));

        state_7(); pulse_gen(1); state_0(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_7(); pulse_gen(1); state_1(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_7(); pulse_gen(1); state_2(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_7(); pulse_gen(1); state_3(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_7(); pulse_gen(1); state_4(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_7(); pulse_gen(1); state_5(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_7(); pulse_gen(1); state_6(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_7(); pulse_gen(1); state_7(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_7(); pulse_gen(1); state_8(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_7(); pulse_gen(1); state_9(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));

        state_8(); pulse_gen(1); state_0(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_8(); pulse_gen(1); state_1(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_8(); pulse_gen(1); state_2(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_8(); pulse_gen(1); state_3(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_8(); pulse_gen(1); state_4(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_8(); pulse_gen(1); state_5(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_8(); pulse_gen(1); state_6(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_8(); pulse_gen(1); state_7(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_8(); pulse_gen(1); state_8(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_8(); pulse_gen(1); state_9(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));

        state_9(); pulse_gen(1); state_0(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_9(); pulse_gen(1); state_1(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_9(); pulse_gen(1); state_2(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_9(); pulse_gen(1); state_3(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_9(); pulse_gen(1); state_4(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_9(); pulse_gen(1); state_5(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_9(); pulse_gen(1); state_6(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_9(); pulse_gen(1); state_7(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_9(); pulse_gen(1); state_8(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
        state_9(); pulse_gen(1); state_9(); latch_gen();_delay((unsigned long)((200)*(1000000/4000.0)));
    }
    return;
}
