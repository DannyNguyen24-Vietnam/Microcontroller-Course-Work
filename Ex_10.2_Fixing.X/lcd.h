...
#define LCD_REG       LATC                             // LCD register pin and select pin RS, RW and E
#define LCD_DB4       LATBbits.LATB4                   // LCD high order bus DB4-DB7
...
#define LCD_EN       LATCbits.LATC2                    // LCD enable
#define LCD_RW       LATCbits.LATC1                    // LCD read/write line
#define LCD_RS       LATCbits.LATC0                    // LCD register select line
...
/**
  @Summary
    Display a string and also set line, position

  @Description
    This function writes the specified nibble to the LCD 
                  also allows user to set line and position of the display
...
void LCDPutStr2(const char *, char _pos, char _line); 
