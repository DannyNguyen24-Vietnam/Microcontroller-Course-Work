...
void sec_countdown(int min_value){
    ...
    while(sec_counter1>=0){
        while(sec_counter2>=0){
            ...
            stop_counting(min_value, sec_counter1, sec_counter2); _delay((unsigned long)((20)*(1000000/4000.0)));
...
void main(void) {
    ...
    WPUBbits.WPUB6=1;
    WPUBbits.WPUB7=1;
    int count=0, temp_val=0;
    int min_digit_1=0, min_digit_2=0, sec_digit_1=0, sec_digit_2=0;
        ...
        if(PORTBbits.RB4==0){
            if(count!=0){
                while(count>=0){
                    ...
                    if (count>=temp_val){
                        count-=1;}
                    num_state_C4(count/10); pulse_gen_C3(1);
